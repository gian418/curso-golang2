...
import (
	...
	"github.com/gian418/conexao_sql/repo"

	"github.com/gian418/conexao_sql/model"
)

//Local é o manipulador de aquisição de rota /local/
func Local(w http.ResponseWriter, r *http.Request) {
	...
	for linha.Next() {
		...
		if err != nil {
			http.Error(w, "Não foi possível pesquisar esse número.", http.StatusInternalServerError)
			fmt.Println("[Local] Não foi possivel fazer o binding dos dados do banco na struct: ", sql, " Erro: ", err.Error())
			return
		}
	}
	...
	if err != nil {
		fmt.Println("[local] Erro ao pegar o numero de linhas afetados pelo comando: ", sql, " Erro:  ", err.Error())
	}
